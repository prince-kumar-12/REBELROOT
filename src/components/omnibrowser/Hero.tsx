...
import HeroAnimation from "@/components/omnibrowser/animations/HeroAnimation";
import MouseTilt from "@/components/omnibrowser/animations/MouseTilt";
      ...
      <section className="relative section-pad pb-20 pt-40 lg:pt-48">
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            >
              <Button
                href="https://play.google.com/store/apps/details?id=com.rebelroot.omni"
                target="_blank"
              ...
              <Button
                href="https://github.com/REBEL-ROOT/omni-browser/releases"
                target="_blank"
                variant="secondary"
                iconPosition="left"
                icon={
