...
export function Footer() {
  const columns = [
    {
      title: "Products",
      links: [
        { label: "Omni Browser",href: "/products/omni-browser",},
        { label: "MOCNovel", href: "/products/mocnovel" },
        { label: "CampCart", href: "/products/campcart" },
        { label: "Openved", href: "/products/openved" },
        { label: "MOC Office", href: "/products/moc-officex" },
      ],
    },
    {
      title: "Resources",
    ...
    },
    {
      title: "Community",
      links: [
        { label: "GitHub", href: "https://github.com/rebelroot" },
        {
          label: "LinkedIn",
          href: "https://www.linkedin.com/company/rebelroot/",
        },
        { label: "Support  & Feedback", href: "/contact#support" },
      ],
    },
    {
      title: "RebelRoot",
  ...
  return (
   <footer className="relative bg-black-300  px-4 py-10 sm:px-8 transition-colors duration-300 ">
      

      <div  className="relative mx-auto max-w-6xl rounded-3xl bg-white  px-10 py-12 sm:px-14 shadow-sm ">
        <div className="grid grid-cols-2 gap-y-10 sm:grid-cols-3 lg:grid-cols-5">
          {columns.map((col) => (
            <div key={col.title}>
              <h3 className="mb-4 text-sm text-neutral-400">{col.title}</h3>
                  ...
                  <li key={link.label}>
                    {link.href.startsWith("http") ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[15px] font-medium text-neutral-900 transition-colors hover:text-neutral-600"
                      >
                        {link.label}
                      </a>
                    ) : (
          ...
          <div>
            <h3 className="mb-4 text-sm text-neutral-400">Follow Us</h3>
            ...
            <h3 className="mb-4 mt-8 text-sm text-neutral-400">Contact</h3>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-6 border-t border-gray-400 pt-6 sm:flex-row sm:items-end">
          <div>
          ...
          <div className="text-left text-sm text-neutral-400 sm:text-right">
            ...
            <p className="mt-1 flex flex-wrap gap-2 sm:justify-end">
              ...
              <span>·</span>
              <Link href="/legal/cookies" className="hover:text-neutral-600">
                Cookies
              </Link>
            </p>
          </div>
