...
export function ContactContent() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        alert(responseText || "Failed to submit contact form.");
        return;
      }
      ...
      alert("Could not connect to the Contact server.");
    }
  }
      ...
      <div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        >
          ...
          <p className="mt-5 max-w-md text-base leading-relaxed text-ink-muted">
            Connect with the RebelRoot team for technical support,
            collaboration opportunities, security concerns, and open-source
            contributions.
          </p>
          ...
          <div className="mt-10 flex items-start gap-3 rounded-xl2 border border-base-border bg-base-card/60 p-5">
            ...
            <p className="text-sm leading-relaxed text-ink-muted">
              ...
              Security reports are prioritized and acknowledged within 24
              hours.
            </p>
          </div>
          ...
          <p id="security" className="mt-6 text-sm text-ink-muted">
            ...
            <Link
              href="/docs#security"
              className="text-electric-soft underline underline-offset-2"
            >
